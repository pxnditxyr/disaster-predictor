...
export const MitigationToast = ( { mitigationActions, disasterTypes } : IProps ) => {
  ...
  return (
    <>
      ...
      <div className={`fixed z-50 top-20 right-12 w-[32rem] p-6 rounded-xl shadow-2xl ${getBackgroundColor(riskLevel)} backdrop-filter backdrop-blur-lg bg-opacity-90 border border-white border-opacity-20 transition-all duration-300 ease-in-out z-20`}>
